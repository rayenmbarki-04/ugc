...
import { NormalUserDashboardComponent } from './components/normal-user-dashboard/normal-user-dashboard';
import { MicroInfluencerComponent } from './components/micro-influencer-dashboard/micro-influencer-dashboard';
import { InfluencerDashboardComponent } from './components/influencer-dashboard/influencer-dashboard';
...
export const routes: Routes = [
  ...
  { path: 'dashboard/user', component: NormalUserDashboardComponent },
  { path: 'dashboard/micro-influencer', component: MicroInfluencerComponent },
  { path: 'dashboard/influencer', component: InfluencerDashboardComponent },
